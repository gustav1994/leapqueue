...
{    
    ...
    /**
     * When we migrate the full LeapQueue library we run a hierarchy of migrations for the tables in the library.
     * The order of the classes in the array is important as it defines the order of the migrations.
     * 
     * @var array
     */
    protected static $migrationClasses = [
        self::class,
        QueueGroup::class,
        Job::class
    ];
    ...
    protected static function migrateOrDownAll( string $method ) : bool
    {
        ...
        return count(self::$migrationClasses) === $successes;
    }
